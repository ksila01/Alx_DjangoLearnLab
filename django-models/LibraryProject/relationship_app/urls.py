...
urlpatterns = [
    ...
    path('book/edit/<int:book_id>/', views.edit_book, name='edit_book'),  # Edit book view (secured)
    path('book/delete/<int:book_id>/', views.delete_book, name='delete_book'),  # Delete book view (secured)
]