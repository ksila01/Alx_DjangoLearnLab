...
editors_group.permissions.add(permissions[0], permissions[1], permissions[2])  # can_view, can_create, can_edit
admins_group.permissions.add(permissions[0], permissions[1], permissions[2], permissions[3])  # all permissions